...
export function getResumeRoundPrompt({resumeText}) {
  return `${resumeText} This is my resume. Now based on my resume above, pick "one" project and ask me a "single" technical project-related question. You are the interviewer of a Software company asking technical questions. Yes ask one question and let me answer it. Keep the question to max 30 words and make sure you have an answer for the question which you can verify later.`
}
