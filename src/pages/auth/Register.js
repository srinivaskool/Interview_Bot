...
export default function Register() {
  ...
  useEffect(() => {
    ...
    setIsThisRegisterCompletePage(searchParams.has("apiKey"));
  ...
  const handleRegisterSubmit = async (e) => {
    const config = {
      url: `${process.env.REACT_APP_REGISTER_REDIRECT_URL}?userEmail=${email}`,
                      ...
                      <div className="col-12">
                        <div className="form-check">
                          <input
                            ...
                            checked={tAndCAgreed}
                            onChange={(e) => setTAndCAgreed(e.target.checked)}
                          />
                          <label
                            className="form-check-label"
                            htmlFor="privacy-term-agree"
                          >
                            {" "}
                            I agree with{" "}
